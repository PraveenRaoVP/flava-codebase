...
import { useGetPosts, useSearchPost } from '@/lib/appwrite/react-query/queriesAndMutations';
  ...
  return (
    <div className="explore-container">
      ...
      <div className="flex-between w-full max-w-5xl mt-16 mb-7">
        ...
        <div className="flex-center bg-dark-3 rounded-xl px-4 py-2 cursor-pointer">
          <p className="small=medium md:base-medium text-light-2 mr-2">All</p>
