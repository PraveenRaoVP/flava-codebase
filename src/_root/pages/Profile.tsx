...
import { useGetCurrentUser, useGetUserById } from '@/lib/appwrite/react-query/queriesAndMutations'
    ...
    <div className='profile-container'>
      <div className="profile-inner_container">
        <div className="flex xl:flex-row flex-col max-xl:items-center flex-1 gap-7">
          <img src={currentUser?.imageUrl || "/assets/icons/profile-placeholder.svg"} alt="profilepic"
